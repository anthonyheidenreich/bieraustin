...
class EL_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$this->items = array(
			...
			'show_cat' =>         array( 'type'          => 'checkbox',
			                                 'std_value'     => 'false',
			                                 'caption'       => __( 'Show Category Tag' ),
			                                 'caption_after' => null,
			                                 'tooltip'       => __( 'This option defines if the category tag will be displayed.' ),
			                                 'form_style'    => 'margin:0 0 0.2em 0',
			                                 'form_width'    => null ),
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $title ) )
		{
			echo $args['before_title'].'<a title="'.$instance['link_to_page_caption'].'" href="'.$instance[ 'url_to_page'].'">'.$title.'</a>'.$args['after_title'];
		}
		...
		$shortcode .= ' show_cat='.$instance['show_cat'];
